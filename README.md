...
**AI Engineer Intern @ SafeLink Innovations** · Seattle, WA  
...
Currently at **SafeLink Innovations**, where I architect ISO 26262-compliant tooling with LLM-driven risk classification, automated HAZOP analysis via Claude Sonnet + FastAPI, and OCR-based document ingestion using OpenCV & Pytesseract.
